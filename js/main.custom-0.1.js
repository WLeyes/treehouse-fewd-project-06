...
window.addEventListener("load", function (event) {
  ...
  function GetIEVersion() {
    ...
    if (agentIndex > 0) return parseInt(userAgent.substring(agentIndex + 5, userAgent.indexOf(".", agentIndex)));else if (!!navigator.userAgent.match(/Trident\/7\./)) return 11;else return 0; //It is not IE
  }
...
function fullscreen() {
  ...
  document.addEventListener("fullscreenchange", function (e) {
    setFullscreenDataForPlayer(!!(document.fullScreen || document.fullscreenElement));
  });
  ...
  var setFullscreenDataForControls = function setFullscreenDataForControls(state) {
    videoControls.setAttribute("data-fullscreen", !!state);
  };
  document.addEventListener("fullscreenchange", function (e) {
    setFullscreenDataForControls(!!(document.fullScreen || document.fullscreenElement));
  });
  document.addEventListener("webkitfullscreenchange", function () {
...
function captionHighlight() {
  ...
  video.addEventListener("timeupdate", function () {
    for (var _i = 0; _i < span.length; _i += 1) {
      ...
      if (video.currentTime > span[_i].getAttribute("data-start") && video.currentTime < span[_i].getAttribute("data-end")) {
...
function settingsMenu() {
  ...
  var playerChoiceMenu = document.querySelector(".player__controls--settings--player-choice");
...
function mediaElement() {
  var play = document.querySelector(".player__controls--play");
  var videoControls = document.querySelector(".player__controls");
  var mediaElementSelected = document.querySelector(".player-choice--mediaElement");
  ...
  mediaElementSelected.addEventListener("click", function () {
    ...
    // create and append to <body> my mediaElement js script
    var myMediaElementJavascriptTag = document.createElement("script");
    myMediaElementJavascriptTag.type = "text/javascript";
    myMediaElementJavascriptTag.src = "js/vendor/mediaElement/myMediaElementScript.js";
